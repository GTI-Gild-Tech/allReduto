...
export function CardapioContent() {
  return (
    <div className="z-0 basis-0 box-border content-stretch flex flex-col gap-6 md:gap-[25px] grow items-center justify-start min-h-screen w-full px-4 sm:px-6 md:px-8 lg:px-0 py-8 md:py-0">
